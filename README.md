...
Vizualizace rotací hráčů v české basketbalové lize (NBL). Automaticky stahuje výsledky z [nbl.basketball](https://nbl.basketball), parsuje play-by-play data z FIBA LiveStats API a generuje interaktivní grafy rotací pro každý zápas.
